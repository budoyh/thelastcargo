...
- head_at_report_generation: `a88c7df`
- working_tree_status_at_generation: `M .gitignore
 M AGENTS.md
 M agent.md
 M demo/agent/candidate_generator.py
 M demo/agent/cargo_filter.py
 M demo/agent/config.py
 M demo/agent/llm_budget.py
 M demo/agent/model_decision_service.py
 M demo/agent/normalization.py
 M demo/agent/preference_compiler.py
 M demo/agent/preference_monitor.py
 M demo/agent/safety.py
 M demo/agent/trace_writer.py
 M demo/agent/world.py
 M docs/EXPERIMENT_LOG.md
 M docs/PROJECT_MEMORY.md
 M reports/compliance_audit.md
 M reports/final_audit_report.md
 M tests/test_crown_y_core.py
 M tools/regret_dashboard.py
 M tools/run_local_eval.py
